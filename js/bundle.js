...
function tabs(tabsSelector, tabsContentSelector, tabsParentSlector, activeClass) {
  var tabs = document.querySelectorAll(tabsSelector),
      tabsContent = document.querySelectorAll(tabsContentSelector),
      tabsParent = document.querySelector(tabsParentSlector);
...
function calculate() {
  var resualt = document.querySelector(".calculating__result span");
  ...
  function calcTotal() {
    if (!sex || !height || !weight || !age || !ratio) {
      resualt.textContent = "_____";
      return;
    }

    if (sex === "female") {
      resualt.textContent = Math.round((447.6 + 9.2 * weight + 3.1 * height - 4.3 * age) * ratio);
    } else {
      resualt.textContent = Math.round((88.26 + 9.2 * weight + 13.4 * height - 5.7 * age) * ratio);
    }
  }
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _service_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/services */ "./js/service/services.js");
;
...
function cards() {
  ...
  (0,_service_services__WEBPACK_IMPORTED_MODULE_3__.getResource)("http://localhost:3000/menu").then(function (data) {
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modal */ "./js/modules/modal.js");
/* harmony import */ var _service_services__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../service/services */ "./js/service/services.js");
;
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      (0,_service_services__WEBPACK_IMPORTED_MODULE_7__.postData)("http://localhost:3000/requests", json).then(function (data) {
        console.log(data);
  ...
  function showThankModals(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_6__.modalOpen)('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_6__.modalClose)('.modal');
    }, 4000);
  }
}
...
/*! export modalOpen [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
...
function modals(triggerSelector, modalSelector, modalTimerId) {
  ...
  var modal = document.querySelector(modalSelector);
  var ModalbtnClose = document.querySelector("[data-close]");
  modalTrigger.forEach(function (btn) {
    btn.addEventListener("click", function () {
      return modalOpen(modalSelector, modalTimerId);
    });
  });
  ...
  ModalbtnClose.addEventListener("click", function () {
    return modalClose(modalSelector);
  });
  ...
  function BtnScrollTop() {
    var scrollBtn = document.querySelector(".btnFixedHead");
...
function sliders(_ref) {
  ...
  if (slides.length < 10) {
    ...
    current.textContent = "0".concat(sliderIndex);
  } else {
  ...
  function sliderFiled() {
    slidesFiled.style.transform = "translate(-".concat(offset, "px)");
  }
